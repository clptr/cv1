...
from application.project.utils import exists_email, not_exists_email, exists_username
...
class SignUpForm(FlaskForm):
    ...
    password_Confirm = PasswordField("Confirm Password", validators=[DataRequired(),Length(min=6), EqualTo("password", message="Password does not match")])
